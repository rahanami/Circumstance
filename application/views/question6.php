...
<body>
6.For the ring oscillator shown in the figure, the propagation delay of each inverter is 100 pico sec. What is the fundamental frequency of the oscillator output?  
<p>
	<img src="http://localhost/questions/img/4.jpg">
</p>
...
<script type="text/javascript">
	var str = "<p>If the state Qa Qb of the counter at the clock time tn is “10” then the state Qa Qb of the counter at tn+3 (after th three clock cycles) will be  </p>",
    i = 0,
    isTag,
    text;
