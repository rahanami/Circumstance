...
<body>
7.The circuit shown in the figure has 4 boxes each described by inputs P,Q,R and outputs Y, Z with the following relation.   
<p>
	<img src="http://localhost/questions/img/5.jpg">
</p>
...
<script type="text/javascript">
	var str = "<p>The circuit shown in the figure has 4 boxes each described by inputs P,Q,R and outputs Y, Z with the following relation. </p>",
    i = 0,
    isTag,
    text;
