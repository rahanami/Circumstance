...
3.A MOD-16 ripple counter is holding the count 10012. What will the count be after 31 clock pulses?
	<form name="q2" action="question3" method="post" >
...
<div align="center">
<form id="form1" name="q3" action="question3" method="post">
<input type="text" name="answer">
<!-- <input type="submit"> -->
...
<script type="text/javascript">
	var str = "<p>A MOD-16 ripple counter is holding the count 10012. What will the count be after 31 clock pulses?</p>",
    i = 0,
    isTag,
    text;
