...
<body>
2.Identify the military grade component.
<p><img src="http://localhost/questions/img/1.jpg"> </p>
<p>
	<form name="q2" action="question2" method="post" >
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-center">
                            <h1><strong>CircuimsTance</strong></h1>    
                        </div> 
...
<div align="center">
<p><img src="http://localhost/questions/assets/img/1.jpg"> </p></div>
<form id="form1" name="q2" action="question2" method="post">
<input type="text" name="answer">
<!-- <input type="submit"> -->
...
<script type="text/javascript">
	var str = "<p>Identify the military grade component.</p>",
    i = 0,
    isTag,
    text;
