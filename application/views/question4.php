...
<body>
4.VDAC=n=0:3∑ 2n-1bnVolts ,b0 is the LSB. Counter starts from clear state. What is the stable value expected? 
<p>
	<img src="http://localhost/questions/img/2.jpg">
</p>
...
<div class="row">
<div class="inner-bg">
<div class="qno">Q4</div>
<div id="typewriter"></div>
<div align="center">
<p>
	<img src="http://localhost/questions/img/2.jpg">
</p>
<form id="form1" name="q4" action="question4" method="post">
<input type="text" name="answer">
<!-- <input type="submit"> -->
...
<script type="text/javascript">
	var str = "<p>VDAC=n=0:3∑ 2n-1bnVolts ,b0 is the LSB. Counter starts from clear state. What is the stable value expected? </p>",
    i = 0,
    isTag,
    text;
